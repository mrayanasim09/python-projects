...
def apply_theme():
    if dark_mode:
        ...
        cal.configure(background="#333333", foreground="#ffffff", selectbackground="#ffff00",
                      selectforeground="#000000", headersbackground="#333333", headersforeground="#ffffff")
        ...
        cal.configure(background="#ffffff", foreground="#333333", selectbackground="#ffff00",
                      selectforeground="#000000", headersbackground="#f2f2f2", headersforeground="#333333")
...
cal = Calendar(frame, selectmode="day", date_pattern="yyyy-mm-dd",
               background="#333333", foreground="#ffffff", selectbackground="#ffff00",
               selectforeground="#000000", headersbackground="#333333", headersforeground="#ffffff",
               font=("Arial", 12), cursor="hand2")
cal.grid(row=0, column=0, columnspan=2, pady=10)

# Create a button to get the selected date
select_date_button = ttk.Button(frame, text="Get Selected Date", command=get_selected_date, cursor="hand2")
select_date_button.grid(row=1, column=0, pady=10)

# Create a label to display the selected date
selected_date_label = ttk.Label(frame, text="Selected Date: ", font=("Arial", 12, "bold"), foreground="white")
...
clear_button = ttk.Button(frame, text="Clear Date", command=lambda: selected_date_label.config(text="Selected Date:"),
                          cursor="hand2")
