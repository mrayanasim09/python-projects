...
def plot_predictions(data, forecast, crypto_name, num_days_ahead):
    ...
    sns.scatterplot(data=forecast.tail(1), x='ds', y='yhat', color='red', label=f'{num_days_ahead}-Day Ahead Prediction', ax=ax)
...
def main():
    crypto_symbols = ['BTC-USD', 'ETH-USD', 'LTC-USD', 'XRP-USD', 'ADA-USD', 'BNB-USD', 'DOGE-USD']
    crypto_names = ['Bitcoin', 'Ethereum', 'Litecoin', 'Ripple', 'Cardano', 'Binance Coin', 'Dogecoin']
